#Grupa 1: Przeanalizuj dane o ”Knee Angle” ze zbioru danych ”gait” z pakietu fda.
...
dane$data
dane$rangeval
#dane dotyczace kolan ch???opc???w 10 cio letnich 
...
#nie bierzemy tego bo nie ma sezonowo???ci
#zdecydowa???y???my si???na na baz??? spline???w bo nie ma sezonowo???ci, a w nim s??? sin i cosinusy wi???c on dobrze modeluje dane sezonowe
